...
// set to true if you want the script to click the button 4 u
...
const interval = setInterval(() => {
    'use strict';
    if (tries >= MAX_TRIES) {
        console.log(`maxTries ${tries} reached. giving up.`)
...
// https://github.com/jiangts/JS-OTP/blob/master/dist/jsOTP-es5.min.js
/*
 * File combining
